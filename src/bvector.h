...
class BVector {
public:
    ImVec4 bColor = { 210.0f/255, 180.0f/255, 160.0f/255, 1.0f };
    ImVec4 bgColor = { 60.0f/255, 75.0f/255, 75.0f/255, 1.0f };
    ImVec4 tbColor = { 170.0f/255, 85.0f/255, 80.0f/255, 1.0f };
    SDL_FRect* rects;
    ...
    void setColor                   (const ImVec4, const Sint8)     noexcept;
